            ...
            <div class="col-lg-6">
                <nav class="nav-menu">
                    <ul>
                        ...
                        <li><a href="./class-details.php">Planing</a></li>
                        <li><a href="./services.php">Services</a></li>
                        <li class="active"><a href="./bar.php">bar</a></li>
                        <li><a href="./contact.php">Contact</a></li>
                    </ul>
                </nav>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 order-lg-1 col-md-6 p-0">
                <div class="ss-pic">
                    <img src="img/services/cafe.jpg" alt="">
                </div>
            </div>
            ...
            <div class="col-lg-3 order-lg-3 col-md-6 p-0">
                <div class="ss-pic">
                    <img src="img/services/boisson.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-3 order-lg-4 col-md-6 p-0">
                <div class="ss-text">
                    <h4>Boisson gazeuse</h4>
                    <p>Prix: 1.5dt</p>
                    <p>Coca cola</p>
                    <p>Fanta</p>
                    <p>Boga sidre</p>
            ...
            <div class="col-lg-3 order-lg-8 col-md-6 p-0">
                <div class="ss-pic">
                    <img src="img/services/smoothie-4.jpg" alt="">
                </div>
            </div>
            ...
            <div class="col-lg-3 order-lg-6 col-md-6 p-0">
                <div class="ss-pic">
                    <img src="img/services/citronnade.jpg" alt="">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3 order-lg-1 col-md-6 p-0">
                <div class="ss-pic">
                    <img src="img/services/croque-monsieur-1.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-3 order-lg-2 col-md-6 p-0">
                <div class="ss-text">
            ...
            <div class="col-lg-3 order-lg-8 col-md-6 p-0">
                <div class="ss-pic">
                    <img src="img/services/panini-2.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-3 order-lg-7 col-md-6 p-0">
                <div class="ss-text second-row">
