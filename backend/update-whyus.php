...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            if (isset($_POST['edit'])) {
                $Title = $_POST['id'];
                $url = "http://localhost/Climbin-main/backend/update-whyus.php?id=" . $id;
                header("Location: {$url}");
            }
            ...
            <div class="container-fluid mt-n10">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="update-whyus.php?Title=<?php echo $_GET['id']; ?>" method="POST"
                              enctype="multipart/form-data">

                            <div class="form-group">
                                <label for="Title">id</label>
                                <input value="<?php echo $id; ?>" name="id" class="form-control"
                                       id="id" type="text" placeholder="Title..."/>
                            </div>

                            <div class="form-group">
                                <label for="Title">Title</label>
                                <input value="<?php echo $Title; ?>" name="Title" class="form-control"
                                       id="restaurant-type" type="text" placeholder="Title..."/>
                            </div>
                            <div class="form-group">
